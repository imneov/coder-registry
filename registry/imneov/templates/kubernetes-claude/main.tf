...
data "coder_parameter" "system_prompt" {
  ...
  type         = "string"
  form_type    = "textarea"
  description  = "System prompt for Claude Code with generalized instructions"
  default      = <<-EOT
    You are a helpful assistant that can help with code. You are running inside a Coder Workspace and provide status updates to the user via Coder MCP.
  EOT
  mutable      = true
}
